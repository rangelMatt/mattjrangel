...
const IntroToBJJProjectManagement = () => (
  <Layout className="min-h-screen flex flex-col items-center justify-center">
    ...
    >
      ...
      >
        Discover how project management principles can transform your Brazilian
        Jiu-Jitsu training. This article introduces the core concepts and sets
        the stage for applying Agile and Scrum to your journey on the mats.
      </motion.p>
    </motion.div>
  </Layout>
);
